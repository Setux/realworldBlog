        ...
        <article className={classes.narticle__container}>
            <form className={classes.narticle__form} onSubmit={handleSubmit(onSubmit)}>
                ...
                <label className={classes.narticle__label}>
                    ...
                    <input className={classes.narticle__input} name="title" defaultValue={title} ref={register({
                        required: true,
                    })} placeholder="Title"/>
                ...
                <label className={classes.narticle__label}>
                    ...
                    <input className={classes.narticle__input} defaultValue={description} name="description" placeholder="Description"
                           ref={register(
                               {
                                   required: true,
                               })}/>
                ...
                <label className={classes.narticle__label}>
                    ...
                    <textarea className={classes.narticle__textarea} defaultValue={body} name="body"
